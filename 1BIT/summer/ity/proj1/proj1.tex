...
\author{Vadim Goncearenco \\ \href{mailto:xgonce00@stud.fit.vutbr.cz}{xgonce00@stud.fit.vutbr.cz} }
\date{}
...
\begin{addmargin}[2em]{2em}
    \hspace{5mm}Čím více \emph{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue}{barev} písma a jiných \textcolor{red}{\textsc{efektů}} \underline{použijeme}, tím \textcolor{orange}{profesionálněji} bude {\large \fontfamily{pzc}\selectfont dokument} vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
\end{addmargin}
\vspace{2mm}
...
V češtině se používají uvozovky typu \uv{9966} místo anglických \uvangl{uvozovek}.
